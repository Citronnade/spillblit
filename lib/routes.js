...
Router.route("/table/:_id", {action: function() {this.render("table", {data: function() {return this.params._id;}});}});
Router.route("/table/:_id/enterBills", {action: function() {this.render("enterBills");}});
